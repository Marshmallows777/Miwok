...
public class PhrasesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        names.add(new Word("hi", "lutti", R.raw.phrase_lets_go));
        names.add(new Word("hello", "otiiko", R.raw.phrase_come_here));
        names.add(new Word("how are you", "tolookosu", R.raw.phrase_im_coming));
        names.add(new Word("i'm good", "oyyisa", R.raw.phrase_yes_im_coming));
        names.add(new Word("yo mf", "massokka", R.raw.phrase_what_is_your_name));
        names.add(new Word("sup nigga", "temmokka", R.raw.phrase_im_feeling_good));

        WordAdapter itemsAdapter = new WordAdapter(this, names, R.color.category_phrases);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
                ...
                if (result == AudioManager.AUDIOFOCUS_REQUEST_GRANTED) {
                    mediaPlayer = MediaPlayer.create(PhrasesActivity.this, word.getmAudioResourceId()); // This will play the audio file corresponding ot the view.
                    mediaPlayer.start();
